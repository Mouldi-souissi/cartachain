            ...
            <div className="col-md-12">
              <div data-aos="zoom-in">
                ...
                <p className="legend lead mb-5">
                  ...
                  track and facilitate payments and other business processes
                  with suppliers, partners, contractors, and most importantly
                  with your customers.
                </p>
              </div>
              <div data-aos="zoom-in">
                ...
                <div className="legend lead mb-5">
                  ...
                  everyone. So every one can know how much any address holds,
                  all its previous transactions and the data transfered between
                  smart contracts. These blockchain features will make fraud
                  more difficult, facilitate accounting process (especialy for
              ...
              <div data-aos="zoom-in">
                ...
                <div className="legend lead mb-5">
                  ...
                  reflects the value of the company, used to pay for some
                  services or to have discounts on others, note that it will be
                  used in most of our services & products. Its transactions are
              ...
              <div data-aos="zoom-in">
                ...
                <div className="legend lead mb-5">
                  ...
                  forever so there is no chance for a 51% Attack that is
                  possible on "Proof Of Work" blockchains, that's why DigiCash
                  Blockchain is more secure than Ethereum, Bitcoin ...
                </div>
              </div>
              <div data-aos="zoom-in">
                <h2 className="mb-5 font-weight-bold section-lines">
                ...
                <div className="legend lead mb-5">
                  ...
                  Bitcoin is kind of reliable and secure today. However, it is
                  not really scalable. Bitcoin, as well as other PoW-based
                  blockchains, have limited performance in terms of transactions
                  per second (TPS). Such limitation is related to the fact that
                  Bitcoin relies on a distributed network of nodes, which need
                  to reach consensus and agree on the current states of the
                  blockchain. In PoA-based networks, like Carthachain
                  Blockchain, transactions and blocks are validated by approved
                  accounts, known as validators, preventing attacks like DoS,
                  51% blockchain attacks... The Proof of Authority model relies
                  on a limited number of block validators and this is what makes
                  it a highly scalable system. Blocks and transactions are
                  verified by pre-approved participants, who act as moderators
                  of the system. PoA addresses enterprise's common concerns of
                  inefficient upgrade and waste of energy. To make Carthachain
                  Blockchain completely decentralized, we give the opportunty to
                  any investor to become a validator in our system after
                  verification. Candidatures will be announced and opened later
